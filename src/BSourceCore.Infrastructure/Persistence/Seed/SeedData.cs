...
public static class SeedData
{
    ...
    private static void SeedGroupPermissions(ModelBuilder modelBuilder)
    {
        var groupPermissions = new[]
        {
            ...
            new { GroupPermissionId = new Guid("00000000-0000-0000-0001-000000000001"), GroupId = AdminGroupId, PermissionId = TenantCreatePermissionId, CreatedAt = DateTimeOffset.Parse("2024-01-01T00:00:00Z"), UpdatedAt = (DateTimeOffset?)null, CreatedBy = (Guid?)null, UpdatedBy = (Guid?)null },
            new { GroupPermissionId = new Guid("00000000-0000-0000-0001-000000000002"), GroupId = AdminGroupId, PermissionId = TenantReadPermissionId, CreatedAt = DateTimeOffset.Parse("2024-01-01T00:00:00Z"), UpdatedAt = (DateTimeOffset?)null, CreatedBy = (Guid?)null, UpdatedBy = (Guid?)null },
            new { GroupPermissionId = new Guid("00000000-0000-0000-0001-000000000003"), GroupId = AdminGroupId, PermissionId = TenantUpdatePermissionId, CreatedAt = DateTimeOffset.Parse("2024-01-01T00:00:00Z"), UpdatedAt = (DateTimeOffset?)null, CreatedBy = (Guid?)null, UpdatedBy = (Guid?)null },
            new { GroupPermissionId = new Guid("00000000-0000-0000-0001-000000000004"), GroupId = AdminGroupId, PermissionId = TenantDeletePermissionId, CreatedAt = DateTimeOffset.Parse("2024-01-01T00:00:00Z"), UpdatedAt = (DateTimeOffset?)null, CreatedBy = (Guid?)null, UpdatedBy = (Guid?)null },

            // User permissions for Admin group
            new { GroupPermissionId = new Guid("00000000-0000-0000-0002-000000000001"), GroupId = AdminGroupId, PermissionId = UserCreatePermissionId, CreatedAt = DateTimeOffset.Parse("2024-01-01T00:00:00Z"), UpdatedAt = (DateTimeOffset?)null, CreatedBy = (Guid?)null, UpdatedBy = (Guid?)null },
            new { GroupPermissionId = new Guid("00000000-0000-0000-0002-000000000002"), GroupId = AdminGroupId, PermissionId = UserReadPermissionId, CreatedAt = DateTimeOffset.Parse("2024-01-01T00:00:00Z"), UpdatedAt = (DateTimeOffset?)null, CreatedBy = (Guid?)null, UpdatedBy = (Guid?)null },
            new { GroupPermissionId = new Guid("00000000-0000-0000-0002-000000000003"), GroupId = AdminGroupId, PermissionId = UserUpdatePermissionId, CreatedAt = DateTimeOffset.Parse("2024-01-01T00:00:00Z"), UpdatedAt = (DateTimeOffset?)null, CreatedBy = (Guid?)null, UpdatedBy = (Guid?)null },
            new { GroupPermissionId = new Guid("00000000-0000-0000-0002-000000000004"), GroupId = AdminGroupId, PermissionId = UserDeletePermissionId, CreatedAt = DateTimeOffset.Parse("2024-01-01T00:00:00Z"), UpdatedAt = (DateTimeOffset?)null, CreatedBy = (Guid?)null, UpdatedBy = (Guid?)null },

            // Group permissions for Admin group
            new { GroupPermissionId = new Guid("00000000-0000-0000-0003-000000000001"), GroupId = AdminGroupId, PermissionId = GroupCreatePermissionId, CreatedAt = DateTimeOffset.Parse("2024-01-01T00:00:00Z"), UpdatedAt = (DateTimeOffset?)null, CreatedBy = (Guid?)null, UpdatedBy = (Guid?)null },
            new { GroupPermissionId = new Guid("00000000-0000-0000-0003-000000000002"), GroupId = AdminGroupId, PermissionId = GroupReadPermissionId, CreatedAt = DateTimeOffset.Parse("2024-01-01T00:00:00Z"), UpdatedAt = (DateTimeOffset?)null, CreatedBy = (Guid?)null, UpdatedBy = (Guid?)null },
            new { GroupPermissionId = new Guid("00000000-0000-0000-0003-000000000003"), GroupId = AdminGroupId, PermissionId = GroupUpdatePermissionId, CreatedAt = DateTimeOffset.Parse("2024-01-01T00:00:00Z"), UpdatedAt = (DateTimeOffset?)null, CreatedBy = (Guid?)null, UpdatedBy = (Guid?)null },
            new { GroupPermissionId = new Guid("00000000-0000-0000-0003-000000000004"), GroupId = AdminGroupId, PermissionId = GroupDeletePermissionId, CreatedAt = DateTimeOffset.Parse("2024-01-01T00:00:00Z"), UpdatedAt = (DateTimeOffset?)null, CreatedBy = (Guid?)null, UpdatedBy = (Guid?)null },

            // Permission permissions for Admin group
            new { GroupPermissionId = new Guid("00000000-0000-0000-0004-000000000001"), GroupId = AdminGroupId, PermissionId = PermissionCreatePermissionId, CreatedAt = DateTimeOffset.Parse("2024-01-01T00:00:00Z"), UpdatedAt = (DateTimeOffset?)null, CreatedBy = (Guid?)null, UpdatedBy = (Guid?)null },
            new { GroupPermissionId = new Guid("00000000-0000-0000-0004-000000000002"), GroupId = AdminGroupId, PermissionId = PermissionReadPermissionId, CreatedAt = DateTimeOffset.Parse("2024-01-01T00:00:00Z"), UpdatedAt = (DateTimeOffset?)null, CreatedBy = (Guid?)null, UpdatedBy = (Guid?)null },
            new { GroupPermissionId = new Guid("00000000-0000-0000-0004-000000000003"), GroupId = AdminGroupId, PermissionId = PermissionUpdatePermissionId, CreatedAt = DateTimeOffset.Parse("2024-01-01T00:00:00Z"), UpdatedAt = (DateTimeOffset?)null, CreatedBy = (Guid?)null, UpdatedBy = (Guid?)null },
            new { GroupPermissionId = new Guid("00000000-0000-0000-0004-000000000004"), GroupId = AdminGroupId, PermissionId = PermissionDeletePermissionId, CreatedAt = DateTimeOffset.Parse("2024-01-01T00:00:00Z"), UpdatedAt = (DateTimeOffset?)null, CreatedBy = (Guid?)null, UpdatedBy = (Guid?)null }
        };
